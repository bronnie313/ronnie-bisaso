...
const Skills = () => {
    return (
        <div className="skills">
            <div>
                <p>My Skills</p>
                <h3>Why Hire Me For Your Next <span className="text-success">Project</span></h3>
                <p><em>I&apos;m so passionate about Software development, 
                    ...
                    passionate Software developers. </em>
                </p>
